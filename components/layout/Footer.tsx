      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex flex-col md:flex-row items-start gap-6 w-full md:w-auto">
          ...
          <div className="text-sm flex-1">
            ...
            <p className="mb-1">📍 Joud Mrebine – North Lebanon</p>
            <p className="mb-1">📞 +961 3 00 78 04</p>
            <p className="mb-1">✉️ info@aljourd.com</p>
          </div>

          {/* Google Map Embed */}
          <div className="w-full max-w-xs mt-4 md:mt-10 self-start">
            <iframe
